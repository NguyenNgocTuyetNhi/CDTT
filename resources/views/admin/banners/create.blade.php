...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 custom-header">Thêm Banner</h1>
        ...
        <div class="card-body">
            <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.banners.index') }}" class="btn btn-outline-dark">
...
<style>
    .custom-header {
        background: linear-gradient(90deg, #6c757d, #495057); /* xám nhạt -> xám đậm */
        color: #fff !important;
        font-weight: 600;
